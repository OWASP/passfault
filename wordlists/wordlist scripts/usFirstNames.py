...
files = glob.glob("usFirstNames/*.txt")
...
usNamesPopular = open('../src/org/owasp/passfault/wordlists/usFirstNamesPopular.words', 'w')
usNamesLongTail = open('../src/org/owasp/passfault/wordlists/usFirstNamesLongTail.words', 'w')
